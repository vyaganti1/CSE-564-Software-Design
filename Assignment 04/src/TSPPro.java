...
class TSPPro extends Observable implements Handler, Runnable {
	private static TSPPro _instance;
	...
	/**
	 * This function is used to create the object class TSPPro and if it is already created, it returns the old object.
	 * That is, there will only be one object this class with different references.
	 * 
	 * @return _instance object of class TSPPro. 
	 */
	public static TSPPro createInstance() {
		if (_instance == null) {
			_instance = new TSPPro();
		}
